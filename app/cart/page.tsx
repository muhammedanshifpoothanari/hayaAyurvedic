              ...
              <div className="bg-gray-50 p-6 rounded-2xl border border-gray-200 sticky top-4 shadow-sm">
                ...
                <div className="space-y-3 mb-6 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">
                      {shipping === 0 ? <span className="text-emerald-600 font-bold">FREE</span> : `SAR ${shipping.toFixed(2)}`}
                    </span>
                  </div>
                </div>
                ...
                <div className="border-t-2 border-gray-200 pt-4 mb-6">
                  <div className="flex justify-between items-baseline">
                    ...
                    <span className="text-2xl font-extrabold text-[#3d2e1e]">SAR {finalTotal.toFixed(2)}</span>
                  </div>
                </div>
                ...
                <div className="mt-6 pt-4 border-t border-gray-200 space-y-2 text-xs text-gray-600">
                  <p className="flex items-center gap-1.5"><Check size={14} className="text-emerald-600" /> Free shipping on orders over SAR 500</p>
