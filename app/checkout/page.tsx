            ...
            {step === 2 && (
              <div className="bg-white p-6 md:p-8 rounded-2xl border border-gray-200 shadow-sm">
                ...
                <div className="space-y-4">
                  {/* Tabby Payment Option (Only Option) */}
                  <label className={`flex items-start gap-4 p-5 border-2 rounded-2xl cursor-pointer transition border-[#3d2e1e] bg-[#3d2e1e]/5`}>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <p className="font-extrabold text-gray-900 text-lg">Tabby</p>
                        <span className="bg-[#33ffd6] text-black font-extrabold text-xs px-2.5 py-0.5 rounded font-sans flex items-center gap-1">
                          <span className="w-1.5 h-1.5 bg-black rounded-full" />
                          tabby
                        </span>
                      </div>
                      <p className="text-xs text-gray-600 mb-2">Split in 4 interest-free payments of <strong>{(total / 4).toFixed(2)} SAR</strong>/month. No fees, fully Sharia-compliant.</p>
                      <div className="flex gap-2">
                        <span className="text-[10px] bg-white border px-1.5 py-0.5 rounded text-gray-500 font-semibold">Installment 1: {(total / 4).toFixed(2)} SAR (Today)</span>
                        <span className="text-[10px] bg-white border px-1.5 py-0.5 rounded text-gray-500 font-semibold">Installment 2-4: {(total / 4).toFixed(2)} SAR/mo</span>
                      </div>
                    </div>
                  </label>
                </div>
              ...
              <div className="bg-white p-6 md:p-8 rounded-2xl border border-gray-200 shadow-sm">
                ...
                <div className="p-5 bg-gray-50 rounded-xl space-y-2 border border-gray-200 mb-6 text-sm">
                  ...
                  <p className="text-gray-600 font-semibold pt-2 border-t mt-2 flex items-center gap-2">
                    Payment: 
                    <span className="bg-[#33ffd6] text-black font-extrabold text-xs px-2 py-0.5 rounded font-sans flex items-center gap-1">
                      <span className="w-1.5 h-1.5 bg-black rounded-full" />
                      tabby
                    </span>
                  </p>
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
              ...
              <div className="border-t border-gray-100 pt-4 space-y-2 text-sm text-gray-600">
                ...
                <div className="flex justify-between text-gray-500">
                  <span>Shipping</span>
                  <span className="font-bold text-green-700 bg-green-50 px-2 py-0.5 rounded text-xs">Free</span>
                </div>
                <div className="flex justify-between text-gray-500">
                  <span>VAT (15%)</span>
                  <span className="font-semibold text-gray-700 text-xs">Included in price</span>
                </div>
