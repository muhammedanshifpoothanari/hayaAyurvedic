            ...
            {isArabic ? (
              <>
                ...
                <section>
                  ...
                  <p>
                    تواصل معنا عبر رقم الواتساب الخاص بالدعم الفني المباشر (+91 99614 00633) أو البريد الإلكتروني (support@hayaayurvedics.com) موضحاً رقم الطلب وسبب الاسترجاع. سيقوم ممثل خدمة العملاء بتنسيق استلام المنتج وإرجاع المبلغ المالي لحسابك أو عبر تابي.
                  </p>
                </section>
              </>
            ) : (
              <>
                <div className="bg-amber-50 border border-amber-200 p-5 rounded-2xl flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600 mt-1">
                      In full compliance with regulations, customers are entitled to request product returns or exchanges within <strong>7 days</strong> of delivery.
                    </p>
                  </div>
                </div>
                ...
                <section>
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-600 pl-4">
                    ...
                    <li>Personal care items and medicines cannot be returned once opened due to health & safety regulations.</li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <p>
                    Contact our WhatsApp support team (+91 99614 00633) or write to support@hayaayurvedics.com mentioning your order ID. We will issue a return shipping label and credit the amount back to your account or refund your installments once items are inspected.
                  </p>
                </section>
              </>
            )}
