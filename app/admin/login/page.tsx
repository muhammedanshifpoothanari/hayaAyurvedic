  ...
  return (
    <div className="min-h-screen bg-[#3d2e1e]/5 flex items-center justify-center p-4">
      ...
      <div className="bg-white rounded-3xl border border-gray-200 shadow-2xl max-w-md w-full p-8 md:p-10 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 right-0 h-1.5 bg-[#1e4620]" />

        <div className="text-center mb-8">
          <div className="mx-auto mb-4 w-14 h-14 bg-[#1e4620]/10 text-[#1e4620] rounded-2xl flex items-center justify-center shadow-inner">
            <ShieldCheck size={28} />
          </div>
          <h1 className="text-2xl font-extrabold text-[#1e4620]">Admin Access Only</h1>
          <p className="text-xs text-gray-500 mt-1 font-medium">Please enter your credentials to access the Haya Ayurvedics dashboard.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#1e4620] font-semibold text-gray-900"
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-2 py-3.5 bg-[#1e4620] hover:bg-[#143016] disabled:opacity-50 text-white font-extrabold rounded-xl text-sm transition shadow-md flex items-center justify-center gap-2"
          >
