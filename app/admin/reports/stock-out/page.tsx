...
const DEFAULT_STOCKOUT_ITEMS = [
  ...
  { _id: '2', name: { en: 'Haya Premium Wellness Kit (Green Accent)', ar: 'مجموعة العناية الفاخرة من هايا' }, barcode: 'BC-552109', categoryId: 'tents', stockQuantity: 1, price: 1450.00 },
  { _id: '3', name: { en: 'Royal Haya Musk & Oud Concentrated Perfume 100ml', ar: 'عطر مسك وعود هايا الملكي' }, barcode: 'BC-772184', categoryId: 'perfumes', stockQuantity: 0, price: 195.00 },
...
export default function StockOutReportPage() {
  ...
  const downloadCSV = () => {
    ...
    link.setAttribute('download', `haya_stock_out_report_${Date.now()}.csv`)
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden print:shadow-none print:border-none print:rounded-none">
        ...
        <div className="p-6 md:p-8">
          <div className="flex justify-between items-center border-b border-gray-300 pb-4 mb-6">
            <div>
              <h2 className="text-xl font-bold text-[#1e4620]">STOCK-OUT & INVENTORY REPORT / تقرير النقص والمخزون</h2>
              <p className="text-xs text-gray-500 font-mono">NABH Approved Facility • Threshold ≤ 5 Items</p>
            </div>
