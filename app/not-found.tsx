      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 py-12 md:py-20">
        <div className="bg-white rounded-3xl p-8 md:p-12 border border-gray-200 shadow-sm text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-10">
            ...
            <a
              href="https://www.instagram.com/haya_ayurvedics"
              target="_blank"
            ...
            >
              ...
              Follow @haya_ayurvedics on Instagram
            </a>
            <a
              href="https://wa.me/919961400633?text=Hello%20Haya%20Ayurvedics%20Support"
              target="_blank"
              rel="noopener noreferrer"
              className="px-6 py-3 bg-[#1e4620] hover:bg-[#1e4620]/90 text-white text-sm font-bold rounded-xl transition shadow-md flex items-center gap-2"
            >
