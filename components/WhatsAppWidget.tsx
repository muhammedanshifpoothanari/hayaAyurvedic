...
export default function WhatsAppWidget() {
  ...
  const messageLines = [
    'Namaste! 🙏',
    'Haya Ayurvedics support here.',
    'Need help booking a treatment? 💬',
  ]
  ...
  const handleSendMessage = () => {
    ...
    const defaultText = `Namaste! I am visiting your Haya Ayurvedics website and would like to inquire about Ayurvedic treatments or bookings. (Page: ${pageUrl})`
      
    const whatsappMessage = encodeURIComponent(defaultText)
    const phoneNumber = '919961400633' 
  ...
  return (
    <>
      ...
      <button
        ...
        title="Chat with Haya Ayurvedics on WhatsApp"
      >
